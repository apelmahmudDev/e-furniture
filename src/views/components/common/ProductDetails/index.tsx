...
const ProductDetails = () => {
	...
	const handleProductDetails = (boolean: boolean) => {
		setProductDetailsOpen(boolean);
	};
	...
	return (
		<div>
			<Button variant="outlined" onClick={() => handleProductDetails(true)}>
				Open alert dialog
			</Button>
			<Dialog
				maxWidth="md"
				open={productDetailsOpen}
				onClose={() => handleProductDetails(false)}
